...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \assinatura{\textbf{Prof. Convidado 1} \\ Convidado 1}
   \assinatura{\textbf{Prof. Convidado 2} \\ Convidado 2}
...
\begin{resumo}
    ...
    modelagem lógica, e o \textit{sqlserver} em conjunto com o \textit{SQL Server 
