...
\begin{document}
	...
	\frame{
		...
		\begin{figure}[h]
			 \centering
			 \includegraphics[width=10cm,keepaspectratio]{../../BancoDeDadosPizzaria/MC_01}
	...
	\frame{
		...
		\begin{figure}[h]
			 \centering
			 \includegraphics[width=10cm,keepaspectratio]{../../BancoDeDadosPizzaria/MC_02}
			 \caption{Modelo conceitual}
			 \label{ModConceitual}
		\end{figure}
    }    
    ...
    \frame{
		...
		\begin{figure}[h]
			 \centering
			 \includegraphics[width=10cm,keepaspectratio]{../../BancoDeDadosPizzaria/MC_03}
			 \caption{Modelo conceitual}
			 \label{ModConceitual}
		\end{figure}
    } 
    ...
    \frame{
		...
		\begin{figure}[h]
			 \centering
			 \includegraphics[width=10cm,keepaspectratio]{../../BancoDeDadosPizzaria/MC_00}
			 \caption{Modelo conceitual}
			 \label{ModConceitual}
		\end{figure}
    } 
	...
	\frame{
		...
		\begin{figure}[h]
			 \centering
			 \includegraphics[width=10cm,keepaspectratio]{../../BancoDeDadosPizzaria/ML_00}
